# StackVM Review Plugin Example

This example shows a multi-file StackVM-backed flow packaged as a normal PocketCoder plugin.

Layout:

- `plugin.yaml`: registers the flow
...
See also `../stackvm_handoff_plugin/` for a VM flow that uses agent handoff instead of a tool loop.