...
- `summarize.md`: StackVM-backed tool-first reduction flow that loads the shared workspace stdlib normalization module plus the local VM modules explicitly
