...
6. Read `plugin_architecture.md`, `pocketflow_agents.md`, `stackvm_patterns.md`, `stackvm_cookbook.md`, and `stackvm_macros.md` when changing runtime resources.
   For StackVM example cleanup or authoring, start with the helper-conventions and architectural split sections in `stackvm_cookbook.md`, then use `stackvm_macros.md` for the compile-time surface and `stackvm_patterns.md` for example starting points.
