...
class ReasonNode(Node):
    ...
    def post(self, shared: Dict[str, Any], prep_res: Any, exec_res: Dict[str, Any]) -> str:
        ...
        # Default to final_answer for any unrecognised action
...
def create_flow() -> Flow:
    ...
    Topology:
        ReasonNode ─(call_tool)──► ActNode ─(observe)──► ObserveNode ─(reason)──► ReasonNode
             │                                                   │
             │ (final_answer / ask_user)                         │ (final_answer)
             ▼                                                   ▼
          FinalNode                                           FinalNode
    ...
    # ObserveNode: loop back or terminate
