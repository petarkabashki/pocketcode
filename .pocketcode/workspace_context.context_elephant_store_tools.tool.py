...
TOOLS = {
    "read_context_elephant_store_file": ReadContextElephantStoreFileTool,
    "write_context_elephant_store_file": WriteContextElephantStoreFileTool,
    "append_to_context_elephant_store_file": AppendToContextElephantStoreFileTool,
    "get_context_elephant_store_summary": GetContextElephantStoreSummaryTool,
    "check_context_elephant_store_status": CheckContextElephantStoreStatusTool,
}
