...
description: Use when creating or editing PocketFlow nodes and flows for PocketCoder. Covers Node, Flow, Batch, Async, retries, shared-store patterns, and how PocketFlow factories are used by PocketCoder namespace assets.
tools:
  - core.read_file
  - core.search_code
---
