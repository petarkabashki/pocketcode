...
Workflow:
1. Identify the asset type first: PocketFlow graph, namespace asset, prompt/profile, tool/runtime behavior, or workspace-level asset.
...
- Treat `pocketcode/core/*.py`, workspace assets, and tests as the source of truth for PocketCoder behavior.
